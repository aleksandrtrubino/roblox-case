...
const Register = () => {
    ...
    const contactButtonById = (id) => {
        switch (id) {
            case 1:
                return(
                    <button type="button" className={styles.socials_button + ' ' + (contactTypeId === 1 ? styles.socials_button_active : '')} onClick={()=>setContactTypeId(1)}>
                        <svg
            ...
            case 2:
                return(
                    <button type="button" className={styles.socials_button + ' ' + (contactTypeId === 2 ? styles.socials_button_active : '')} onClick={()=>setContactTypeId(2)}>
                        <svg
                            className={styles.socials_icon}
                            viewBox="0 0 32 32"
                            version="1.1"
            ...
            case 3:
                return(
                    <button type="button" className={styles.socials_button + ' ' + (contactTypeId === 3 ? styles.socials_button_active : '')} onClick={()=>setContactTypeId(3)}>
                        <svg
                            className={styles.socials_icon}
                            viewBox="-2.5 0 32 32"
                            version="1.1"
            ...
            case 4:
                return(
                    <button type="button" className={styles.socials_button + ' ' + (contactTypeId === 4 ? styles.socials_button_active : '')} onClick={()=>setContactTypeId(4)}>
                        <svg
                            className={styles.socials_icon}
                            xmlns="http://www.w3.org/2000/svg"
                            width="24" height="24"
